...
import { getCustomTemplatePath, isCustomTemplate } from './custom-template-helpers';

import type { Template } from '../types';

export async function getTemplate(rawTemplate?: string): Promise<Template | undefined> {
